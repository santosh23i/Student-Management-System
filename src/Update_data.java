...
public class Update_data extends JFrame implements ActionListener
{
    ...
    public void setlocandsize()
    {
        ...
        updateButton.setBounds(70,555,150,50);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        if(ae.getSource()==updateButton)
        {
            ...
            String acadmic_year=acadmic_yearBox.getSelectedItem().toString();
            ...
            try 
            {
                ...
                Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/stud_db","root","");
                Statement stmt=con.createStatement();
                String sql="update student set roll ='"+roll+"',name ='"+name+"',year ='"+year+"',branch ='"+branch+"',acadmic_year ='"+acadmic_year+"',age ='"+age+"',email ='"+email+"' where roll='"+searchString+"'";
